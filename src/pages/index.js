...
const Home = () => {
  ...
  return (
    <div className="overflow-hidden">
     ...
     <div className="relative max-w-[1200px] mx-auto min-h-[calc(100vh-180px)] md:min-h-[calc(100vh-150px)] md2:min-h-[calc(100vh-170px)] lg2:min-h-[calc(100vh-200px)]">
     <Header/>
    ...
    ”
        ...
        //  onClick={() => handleSendMessage("Job search strategies for international students?")}
         >Job search strategies for international students?</button>
        <button className="mainButton flex px-4 py-3 font-[600] border border-main-dark rounded-lg transition hover:bg-main hover:text-white hover:border-main w-fit"
        // onClick={() => handleSendMessage("How can I stand out in my job application?")}
        >How can I stand out in my job application?</button>
        <button className="mainButton flex px-4 py-3 font-[600] border border-main-dark rounded-lg transition hover:bg-main hover:text-white hover:border-main w-fit"
        //  onClick={() => handleSendMessage("How to crack a job as a complete fresher?")}
         >How to crack a job as a complete fresher?</button>
        </div>
      </div>
      </Fade>
     </div>
